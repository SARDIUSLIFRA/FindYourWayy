...
public class Mactivity extends AppCompatActivity implements
        ConnectionCallbacks,
    ...
    public void onResume() {
        ...
        if (ActivityCompat.checkSelfPermission(Mactivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
